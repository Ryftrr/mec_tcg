...
import pygame, sys, math, random, time, Deck
...
theme = pygame.mixer.Sound("sounds/mecTheme.ogg")

clonePic  = pygame.image.load("graphics/profiles/obiwan_profile.png" )
droidPic  = pygame.image.load("graphics/profiles/gengrev_profile.png")
jediPic   = pygame.image.load("graphics/profiles/luke_profile.png"   )
sithPic   = pygame.image.load("graphics/profiles/vader_profile.png"  )
...
def initDeck(playerclass):
    # list format [picname, attack, health, force cost, status (hand position or position on field),attack status]
    droid1 = ["graphics/cards/BATTLEDROID.png", 1, 1, 0, "deck", "na"]
    droid2 = ["graphics/cards/BATTLEDROID.png", 1, 1, 0, "deck", "na"]
    droid3 = ["graphics/cards/BATTLEDROID.png", 1, 1, 0, "deck", "na"]
    droid4 = ["graphics/cards/BATTLEDROID.png", 1, 1, 0, "deck", "na"]
    droid5 = ["graphics/cards/BATTLEDROID.png", 1, 1, 0, "deck", "na"]
    droid6 = ["graphics/cards/BATTLEDROID.png", 1, 1, 0, "deck", "na"]
    droid7 = ["graphics/cards/BATTLEDROID.png", 1, 1, 0, "deck", "na"]
    droid8 = ["graphics/cards/SUPERBD.png", 3, 3, 3, "deck", "na"]
    droid9 = ["graphics/cards/SUPERBD.png", 3, 3, 3, "deck", "na"]
    droid10 = ["graphics/cards/DROIDEKA.png", 5, 1, 4, "deck", "na"]
    droid11 = ["graphics/cards/DROIDEKA.png", 5, 1, 4, "deck", "na"]
    droid12 = ["graphics/cards/DROIDEKA.png", 5, 1, 4, "deck", "na"]
    droid13 = ["graphics/cards/IG88.png", 4, 4, 6, "deck", "na"]
    droid14 = ["graphics/cards/IG88.png", 4, 4, 6, "deck", "na"]
    droid15 = ["graphics/cards/JANGOFETT.png", 7, 5, 8, "deck", "na"]
    droid16 = ["graphics/cards/TUSKENRAIDER.png", 2, 1, 2, "deck", "na"]
    droid17 = ["graphics/cards/TUSKENRAIDER.png", 2, 1, 2, "deck", "na"]
    droid18 = ["graphics/cards/TUSKENRAIDER.png", 2, 1, 2, "deck", "na"]
    droid19 = ["graphics/cards/JARJARBINK.png", 1, 5, 4, "deck", "na"]
    droid20 = ["graphics/cards/JARJARBINK.png", 1, 5, 4, "deck", "na"]

    clone1 = ["graphics/cards/CLONETROOPER.png", 3, 1, 3, "deck", "na"]
    clone2 = ["graphics/cards/CLONETROOPER.png", 3, 1, 3, "deck", "na"]
    clone3 = ["graphics/cards/CLONETROOPER.png", 3, 1, 3, "deck", "na"]
    clone4 = ["graphics/cards/CLONETROOPER.png", 3, 1, 3, "deck", "na"]
    clone5 = ["graphics/cards/CLONETROOPER.png", 3, 1, 3, "deck", "na"]
    clone6 = ["graphics/cards/ROYAL GUARDS.png", 2, 3, 3, "deck", "na"]
    clone7 = ["graphics/cards/ROYAL GUARDS.png", 2, 3, 3, "deck", "na"]
    clone8 = ["graphics/cards/ROYAL GUARDS.png", 2, 3, 3, "deck", "na"]
    clone9 = ["graphics/cards/ROYAL GUARDS.png", 2, 3, 3, "deck", "na"]
    clone10 = ["graphics/cards/ATTE.png", 3, 3, 3, "deck", "na"]
    clone11 = ["graphics/cards/ATTE.png", 3, 3, 3, "deck", "na"]
    clone12 = ["graphics/cards/ATTE.png", 3, 3, 3, "deck", "na"]
    clone13 = ["graphics/cards/COMMANDERCODY.png", 4, 3, 5, "deck", "na"]
    clone14 = ["graphics/cards/COMMANDERCODY.png", 4, 3, 5, "deck", "na"]
    clone15 = ["graphics/cards/PADME.png", 7, 4, 7, "deck", "na"]
    clone16 = ["graphics/cards/TUSKENRAIDER.png", 2, 1, 2, "deck", "na"]
    clone17 = ["graphics/cards/TUSKENRAIDER.png", 2, 1, 2, "deck", "na"]
    clone18 = ["graphics/cards/TUSKENRAIDER.png", 2, 1, 2, "deck", "na"]
    clone19 = ["graphics/cards/JARJARBINK.png", 1, 5, 4, "deck", "na"]
    clone20 = ["graphics/cards/JARJARBINK.png", 1, 5, 4, "deck", "na"]

    jedi1 = ["graphics/cards/REBELTROOPER.png", 1, 3, 1, "deck", "na"]
    jedi2 = ["graphics/cards/REBELTROOPER.png", 1, 3, 1, "deck", "na"]
    jedi3 = ["graphics/cards/REBELTROOPER.png", 1, 3, 1, "deck", "na"]
    jedi4 = ["graphics/cards/REBELTROOPER.png", 1, 3, 1, "deck", "na"]
    jedi5 = ["graphics/cards/REBELTROOPER.png", 1, 3, 1, "deck", "na"]
    jedi6 = ["graphics/cards/REBELPILOT.png", 3, 2, 3, "deck", "na"]
    jedi7 = ["graphics/cards/REBELPILOT.png", 3, 2, 3, "deck", "na"]
    jedi8 = ["graphics/cards/REBELPILOT.png", 3, 2, 3, "deck", "na"]
    jedi9 = ["graphics/cards/XWING.png", 5, 2, 4, "deck", "na"]
    jedi10 = ["graphics/cards/XWING.png", 5, 2, 4, "deck", "na"]
    jedi11 = ["graphics/cards/PRINCESSLEIA.png", 6, 4, 8, "deck", "na"]
    jedi12 = ["graphics/cards/PRINCESSLEIA.png", 6, 4, 8, "deck", "na"]
    jedi13 = ["graphics/cards/HANSOLO.png", 6, 4, 8, "deck", "na"]
    jedi14 = ["graphics/cards/TUSKENRAIDER.png", 2, 1, 2, "deck", "na"]
    jedi15 = ["graphics/cards/TUSKENRAIDER.png", 2, 1, 2, "deck", "na"]
    jedi16 = ["graphics/cards/TUSKENRAIDER.png", 2, 1, 2, "deck", "na"]
    jedi17 = ["graphics/cards/JARJARBINK.png", 1, 5, 4, "deck", "na"]
    jedi18 = ["graphics/cards/JARJARBINK.png", 1, 5, 4, "deck", "na"]
    jedi19 = ["graphics/cards/LANDSPEEDER.png", 3, 1, 2, "deck", "na"]
    jedi20 = ["graphics/cards/LANDSPEEDER.png", 3, 1, 2, "deck", "na"]

    sith1 = ["graphics/cards/STORMTROOPER.png", 2, 2, 1, "deck", "na"]
    sith2 = ["graphics/cards/STORMTROOPER.png", 2, 2, 1, "deck", "na"]
    sith3 = ["graphics/cards/STORMTROOPER.png", 2, 2, 1, "deck", "na"]
    sith4 = ["graphics/cards/STORMTROOPER.png", 2, 2, 1, "deck", "na"]
    sith5 = ["graphics/cards/STORMTROOPER.png", 2, 2, 1, "deck", "na"]
    sith6 = ["graphics/cards/SANDTROOPER.png", 2, 3, 2, "deck", "na"]
    sith7 = ["graphics/cards/SANDTROOPER.png", 2, 3, 2, "deck", "na"]
    sith8 = ["graphics/cards/SANDTROOPER.png", 2, 3, 2, "deck", "na"]
    sith9 = ["graphics/cards/SANDTROOPER.png", 2, 3, 2, "deck", "na"]
    sith10 = ["graphics/cards/SANDTROOPER.png", 2, 3, 2, "deck", "na"]
    sith11 = ["graphics/cards/ATST.png", 2, 3, 4, "deck", "na"]
    sith12 = ["graphics/cards/ATST.png", 2, 3, 4, "deck", "na"]
    sith13 = ["graphics/cards/BOBAFETT.png", 5, 3, 5, "deck", "na"]
    sith14 = ["graphics/cards/BOBAFETT.png", 5, 3, 5, "deck", "na"]
    sith15 = ["graphics/cards/PALPATINE.png", 5, 7, 7, "deck", "na"]
    sith16 = ["graphics/cards/JARJARBINK.png", 1, 5, 4, "deck", "na"]
    sith17 = ["graphics/cards/JARJARBINK.png", 1, 5, 4, "deck", "na"]
    sith18 = ["graphics/cards/RANCOR.png", 6, 5, 7, "deck", "na"]
    sith19 = ["graphics/cards/RANCOR.png", 6, 5, 7, "deck", "na"]
    sith20 = ["graphics/cards/LANDSPEEDER.png", 3, 1, 2, "deck", "na"]

    if playerclass == "Droid":
        cardlist = [droid1, droid2, droid3, droid4, droid5, droid6, droid7, droid8, droid9, droid10, droid11, droid12,
                    droid13, droid14, droid15, droid16, droid17, droid18, droid19, droid20]
    elif playerclass == "Clone":
        cardlist = [clone1, clone2, clone3, clone4, clone5, clone6, clone7, clone8, clone9, clone10, clone11, clone12,
                    clone13, clone14, clone15, clone16, clone17, clone18, clone19, clone20]
    elif playerclass == "Jedi":
        cardlist = [jedi1, jedi2, jedi3, jedi4, jedi5, jedi6, jedi7, jedi8, jedi9, jedi10, jedi11, jedi12, jedi13,
                    jedi14, jedi15, jedi16, jedi17, jedi18, jedi19, jedi20]
    elif playerclass == "Sith":
        cardlist = [sith1, sith2, sith3, sith4, sith5, sith6, sith7, sith8, sith9, sith10, sith11, sith12, sith13,
                    sith14, sith15, sith16, sith17, sith18, sith19, sith20]
    return cardlist
...
def main():
    ...
    while(True):
        ...
        # if the game has not started, init the class selection screen
        if gameInPlay == False:
            initClassScreen()
        ...
        if gameInPlay:
            ...
            if textbounds.collidepoint(pygame.mouse.get_pos()):
                if(event.type == pygame.MOUSEBUTTONDOWN and event.button == 1):
                    ...
                    # check if they click on a card in hand, remove it from hand, subtract force, and put in play
